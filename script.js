...
const COUNTRY_FLAG_GET_URL = "https://flagsapi.com";
const FETCH_OPTIONS = {
  method: "GET",
  headers: {
    "X-RapidAPI-Key": "d74b88bcb4mshecccd5d6cb19568p186050jsnf4a31e4620bf",
...
const PLACES_TABLE_FIELDS_MAP = {
  ...
  country: {
    ...
    getHtml: function (element, index) {
      ...
      <img src="${COUNTRY_FLAG_GET_URL}/${element.countryCode}/flat/64.png" />
      ${element.country}
      </td>`;
    },
  },
